...
func main() {
	...
	commandAdminList := []commandList{
		...
		{tele.Command{Text: "kilobite", Description: "сильно укусить кого-нибудь"}, commands.Kill, moder},
		{tele.Command{Text: "megabite", Description: "очень сильно укусить кого-нибудь"}, commands.Kill, moder},
